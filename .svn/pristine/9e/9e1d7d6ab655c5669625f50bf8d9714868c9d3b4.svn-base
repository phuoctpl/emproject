...
<title>Changer password - Emoutional Music</title>
            ...
            <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
                <div class="login-box clearfix animated flipInY">
                    ...
                    <div class="login-form">
                        ...
                        <s:form id="form4" role="form" action="change" method="post" cssClass="icon-validation" >
                        	<s:password name="passwd" placeholder="Enter old password" cssClass="input-field" parsley-required="true" ></s:password>
                            ...
                            <button type="submit" class="btn btn-login" onclick="javascript:$('#form4').parsley('validate');">Change</button>
                        </s:form>
                        <div class="login-links">
                            <a href="../../home.action"><strong>Emoutional Music</strong></a>
                        </div>
                    </div>
                </div>
            </div>
