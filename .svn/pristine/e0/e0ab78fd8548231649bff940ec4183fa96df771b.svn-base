                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <h3><strong>Flat</strong> style</h3>
                                    <p>You want beautiful and original checkbox and many colors choice?</p>
                                    <br>
                                ...
                                <div class="col-md-4">
                                    <h3><strong>Line</strong> skin</h3>
                                    <p>Line skin permit you to propose new way to consider checkbox.</p>
                                    <br>
                                    ...
                                    <div class="skin skin-minimal">
                                        ...
                                        <div class="skin skin-minimal">
                                            ...
                                            <div class="skin-section">
                                                <ul class="list">
                                                    <li>
                                                        <input tabindex="5" type="checkbox" data-style="minimal-green">
                                                        <label for="minimal-checkbox-1">Checkbox 1</label>
                                                    </li>
                                                    <li>
                                                        <input tabindex="6" type="checkbox" data-style="minimal-green" checked>
                                                        <label for="minimal-checkbox-2">Checkbox 2</label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" data-style="minimal-green" disabled>
                                                        <label for="minimal-checkbox-disabled">Disabled</label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" data-style="minimal-green" checked disabled>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 m-b-40">
                                    ...
                                    <p class="m-b-60">Different types of radio button. You can change color too.</p>
                                    <div class="skin">
                                        <div class="form-group">
                                            <div class="skin-section">
                                                <ul class="list col-md-6">
                                                    <li>
                                                        <input tabindex="7" type="radio" data-style="minimal-blue" name="minimal-radio" checked>
                                                        <label for="minimal-radio-1">Minimal Radio checked</label>
                                                    </li>
                                                    <li>
                                                        <input tabindex="11" type="radio" data-style="square-blue" name="square-radio" checked>
                                                        <label for="square-radio-1">Square Radio checked</label>
                                                    </li>
                                                    <li>
                                                        <input type="radio" checked name="flat-radio">
                                                        <label for="flat-checkbox-disabled">Flat Radio checked</label>
                                                    </li>
                                                </ul>

                                                <ul class="list col-md-6">
                                                    <li>
                                                        <input tabindex="7" type="radio" data-style="minimal-blue" name="minimal-radio">
                                                        <label for="minimal-radio-1">Minimal Radio unchecked</label>
                                                    </li>
                                                    <li>
                                                        <input tabindex="11" type="radio" data-style="square-blue" name="square-radio">
                                                        <label for="square-radio-1">Square Radio unchecked</label>
                                                    </li>
                                                    <li>
                                                        <input type="radio" name="flat-radio">
                                                        <label for="flat-checkbox-disabled">Flat Radio unchecked</label>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <h3><strong>Color</strong> Options</h3>
                                    <p>Use of different color opacity tipss to destigues between different states such as disable</p>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-12">
