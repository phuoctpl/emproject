					...
					<div class="panel-body">
						<div class="row">
							<div class="post-image">
								<img
									...
									class=" avatar-user-comment" alt="avatar 4">
							</div>
						...
						<div class="row">
							<div class="infor-post">
								...
								<a id='report' data-modal="modal-1"
...
.uiBoxYellow {
	visibility: false;
							...
							<%
								String linkFacebookComment = "http://localhost:8080/EM_Framework/pages/posts/detailPostAudio.action?id="
										+ request.getParameter("id");
							%>
							<div class="fb-comments" data-href="<%=linkFacebookComment%>"
   ...
   <input type="hidden" value="<%= session.getAttribute("userId") %>" id="userId">
		...
		<jsp:include
			page="../../assets/elements/element_pack/detail_post_audioE.jsp" />
		<!-- END MAIN CONTENT -->
		<!-- Setup video player-->
