...
<body data-page="forms">
	...
	<div id="main-content">
            <div class="page-title"> <i class="icon-custom-left"></i>
                <h3><strong>Admin</strong> manager</h3>
            </div>
            <div class="row">
                <div class="col-md-12">
                                ...
                                <s:form id="form1" action="addNewAdmin">
                                    <table class="table table-striped table-hover table-dynamic" id="table-editable" >
                                        ...
                                        <s:iterator value="memberList">
                                            <tr>
												<s:url id="lock" action="doManagerAdmin.action">
													<s:param name="userId">
														<s:property value="_id" />
													</s:param>
												</s:url>
												<s:url id="unlock" action="doManagerAdmin.action">
													<s:param name="userId">
														<s:property value="_id" />
													</s:param>
												</s:url>
